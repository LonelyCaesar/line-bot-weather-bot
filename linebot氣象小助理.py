...
def earth_quake():
    ...
    try:
        ...
        url = f'https://opendata.cwa.gov.tw/api/v1/rest/datastore/E-A0016-001?Authorization=CWA-30010294-FD42-486A-84EF-094F518DD29C'
...
def current_weather(address):
    msg = '找不到氣象資訊。' # 預設回傳訊息
    code = 'CWA-30010294-FD42-486A-84EF-094F518DD29C'
    url = f'https://opendata.cwa.gov.tw/fileapi/v1/opendataapi/O-A0001-001?Authorization=CWA-30010294-FD42-486A-84EF-094F518DD29C&downloadType=WEB&format=JSON'
    url = f'https://opendata.cwa.gov.tw/fileapi/v1/opendataapi/O-A0003-001?Authorization=CWA-30010294-FD42-486A-84EF-094F518DD29C&downloadType=WEB&format=JSON'
...
def forecast(address):
    ...
    try:
        code = 'CWA-30010294-FD42-486A-84EF-094F518DD29C'
        url = f'https://opendata.cwa.gov.tw/fileapi/v1/opendataapi/F-C0032-001?Authorization=CWA-30010294-FD42-486A-84EF-094F518DD29C&downloadType=WEB&format=JSON'
...
def linebot():
    ...
    try:
        access_token = 'b2nbojfIeeN+MzyBjxZUnACp2Ql5V5QJP5PQt40LQ9PM5AFXTa5v10rdXrTcvX8ogqZhA3msnc3sgIOubsGSq+QnUGhD3rOi7YTTsYsLtAnqmK2LmDbWH/2StAAoHTcNpo7KX5kDQ/f8YWAnu9hDeQdB04t89/1O/w1cDnyilFU='
        secret = '9e13e044fb91ff74d04f93cf4e6aa168'
